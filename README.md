...
- The workflow is designed to run from the committed Phase 1 inputs in this repository.
...
1. `docs/score_definition.md` — methodology and score definition
2. `outputs/summary/top_100_riskiest_segments_combined.csv` — global top 100 segments
3. `outputs/summary/top_20_per_country.csv` — top segments per country
4. `outputs/maps/thailand_speed_safety_map.html` — interactive Thailand map
5. `outputs/maps/maharashtra_speed_safety_map.html` — interactive Maharashtra map
6. `outputs/scored/` — full scored artifacts for auditability and inspection
